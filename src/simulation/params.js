...
export const PARAMS = {
  ...
  pressSupportRadius: 9, // 압박이 최대일 때 두 번째 선수가 볼로 달려드는 거리(m)
  pressDrainBase: 1.0, // 압박 0.5에서의 체력 소모 배수 기준값
  pressDrainSpread: 0.1, // 압박이 체력 소모를 얼마나 더 키우는지(0↔1의 폭)
  tempoDecisionScale: 0.9, // 템포가 캐리어 판단 주기를 줄이는 비율 (0.5에서 배수 1)
  tempoPassForceScale: 0.6, // 템포가 패스 힘을 키우는 비율 (0.5에서 배수 1)
};
